...
import { HiViewGridAdd, HiOutlineHome, HiOutlineBookOpen, HiOutlineTag, HiOutlineShoppingCart, HiOutlineUserGroup, HiOutlineUser } from "react-icons/hi";
    ...
    <aside className="hidden sm:flex sm:flex-col">
      ...
      <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
        <nav className="flex flex-col mx-4 my-6 space-y-4">
          <Link to="/dashboard/account-management" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            <span className="sr-only">Account Management</span>
          ...
          <Link to="/dashboard/manage-categories" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            <span className="sr-only">Manage Categories</span>
            <HiOutlineTag className="h-6 w-6 mr-2"/>
          </Link>
          <Link to="/dashboard/manage-orders" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
            ...
            <HiOutlineShoppingCart className="h-6 w-6 mr-2"/>
          </Link>
        </nav>
